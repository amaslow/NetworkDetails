...
public class ParseRoute {
    ...
    public static void main(String[] args) {
        try {
            ...
            short submask = networkInterface.getInterfaceAddresses().get(0).getNetworkPrefixLength();

            JOptionPane.showMessageDialog(null, "User: " + System.getProperty("user.name")
                    + "\n" + "Computer name: " + localHost.getHostName()
                    + "\n"
                    + "\n" + "IP: " + pr.getLocalIPAddress()
                    + "\n" + "Submask: " + submask
                    + "\n" + "Gateway: " + pr.getGateway()
                    + "\n" + "Java: " + System.getProperty("java.version"), "Network details", JOptionPane.INFORMATION_MESSAGE);
